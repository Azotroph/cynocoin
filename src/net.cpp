...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Cynocoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"cynocoin.org", "dnsseed.cynocoin.org"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"cynocoin.org", "testnet-seed.cynocoin.org"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Cynocoin is probably already running."), addrBind.ToString().c_str());
        else
